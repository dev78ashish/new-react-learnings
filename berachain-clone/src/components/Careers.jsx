...
const Careers = () => {
    return (
        <div className='bg-[#15161F] w-full text-white h-[120vh] relative'>
            ...
            <div className='absolute md:hidden block inset-0 w-[100%] h-[100%]'>
                    <img src={rock1} className='absolute top-[15%] rotate-125 left-[18%] w-[25vw] h-auto floating' alt="rock" />
                <img src={rock2} className='absolute top-[40%] left-[3%] w-[40vw] h-auto floating' alt="rock" />
                <img src={rock1} className='absolute bottom-[10%] right-[10%] w-[40vw] h-auto floating' alt="rock" />
            </div>

            <div className='flex justify-center md:justify-between items-center px-12 mt-20 z-10'>
                {/* Left Rocks */}
                <div className='relative md:block hidden w-[25vw] h-[60vh]'>
